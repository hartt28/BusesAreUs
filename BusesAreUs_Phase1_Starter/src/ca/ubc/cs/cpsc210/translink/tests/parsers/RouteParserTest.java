...
public class RouteParserTest {
    ...
    public void testMissingData()throws RouteDataMissingException,JSONException,IOException{
        RouteParser p = new RouteParser("allroutesedited.json");
        p.parse();
    }

    @Test(expected = JSONException.class)
    public void testErrorFormat() throws RouteDataMissingException,JSONException,IOException
    {
        RouteParser p = new RouteParser("allrouteseditedagain.json");
        p.parse();
    }
}
